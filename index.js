...
const Game = {
	...
	sounds: {
		...
		0: new Audio('./assets/explode_11.mp3'),
		1: new Audio('./assets/explode_11.mp3'),
		2: new Audio('./assets/explode_11.mp3'),
		3: new Audio('./assets/explode_11.mp3'),
		4: new Audio('./assets/explode_11.mp3'),
		5: new Audio('./assets/explode_11.mp3'),
		6: new Audio('./assets/explode_11.mp3'),
		7: new Audio('./assets/explode_11.mp3'),
		8: new Audio('./assets/explode_11.mp3'),
		9: new Audio('./assets/explode_11.mp3'),
		10: new Audio('./assets/explode_11.mp3'),
	},
